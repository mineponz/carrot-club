 ...
 */
export const SITE_TAGLINE = '2026年募集馬94頭を血統・馬体・価格で比較';

export const SITE_DESCRIPTION =
  '【非公式】2026年キャロットクラブ募集馬94頭を、父・母父・体高・胸囲・管囲・馬体重・一口価格・厩舎で並べ替え、絞り込みできる出資馬検討ツール。一口馬主が個人で作ったもので、株式会社キャロットクラブとは関係ありません。自分の評価（A〜E・お気に入り・消・メモ）はブラウザに保存され、netkeibaやXの検索へもすぐ飛べます。';
