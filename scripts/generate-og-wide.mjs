...
const PARTS = {
  carrot: { x: 155, y: 340, w: 190, h: 275, outH: 236 },
  stamp: { x: 795, y: 478, w: 330, h: 134, outH: 46 },
  club: { x: 112, y: 195, w: 380, h: 92, outH: 62 },
  // 「ツール」の「ル」の右払いは元画像の x=1059 まであるので、右端は1065まで取る
  // （「で」の始まりは x=1077。上の装飾線は y=199 までなので y は202から取って外す）。
  // 下端はオレンジの下線（y=306-309）を含める。
  tool: { x: 485, y: 202, w: 580, h: 114, outH: 132 },
